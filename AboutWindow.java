...
public class AboutWindow extends JFrame {
	...
	private AboutWindow() {
		...
		JLabel lblLink = new JLabel("https://www.linkedin.com/in/vraig-de-leon-6112561b7/");
		...
		lblLink.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    Desktop.getDesktop().browse(new URI("https://www.linkedin.com/in/vraig-de-leon-6112561b7/"));
                } catch (Exception ex) {
                	ex.printStackTrace();
                }
            }
